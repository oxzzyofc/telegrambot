...
import urllib
from OxzzyMusic.infra.concurrency.ci import deterministic_privilege_validator
from OxzzyMusic.telegram_client.vector_transport import vector_transport_resolver
from OxzzyMusic.infra.vector.yt_vector_orchestrator import yt_vector_orchestrator
from OxzzyMusic.infra.vector.yt_backup_engine import yt_backup_engine
from OxzzyMusic.infra.chrono.chrono_formatter import quantum_temporal_humanizer
from OxzzyMusic.vector_text_tools import vectorized_unicode_boldifier
...
BOT_NAME = os.environ.get("BOT_NAME", "OXZZY OFC")
BOT_LINK = os.environ.get("BOT_LINK", "https://t.me/oxzzybot")
...
async def start_handler(_, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(f"📢 {updates_text}", url="https://t.me/oxzzybot")
        ],
        [
            InlineKeyboardButton(f"💬 {support_text}", url="https://t.me/oxzzybot"),
...
async def fallback_local_playback(chat_id: int, message: Message, song_info: dict):
    ...
    try:
        ...
        base_caption = (
            "<blockquote>"
            "<b>🎧 OXZZY ✘ MUSIC Streaming</b> (Local Playback)\n\n"
...
async def frozen_check_command(_, message):
    await message.reply_text("oxzzy check successful ✨")
...
if __name__ == "__main__":
    ...
    logger.info("Starting Oxzzy Music Bot services...")
